...
class scaled_out_simulator:
    ...
    def calc_overall_stats_all_layer(self):
        ...
        for layer_id in range(num_layers):
            ...
            output_file_path_ALL_Layers_layerinfo = f'./ResSimulation_WS/{topology_name}/{gridName1*gridName2:04d}/{gridName1:04d}&{gridName2:04d}/LayerBasedInfo'
            output_file_path_ALL_Layers = f'./ResSimulation_WS/{topology_name}/{gridName1*gridName2:04d}/{gridName1:04d}&{gridName2:04d}/LayerBasedInfo/Layer{layer_id:02d}.txt'
            output_file_path_ALL_Layers2 = f'./ResSimulation_WS/{topology_name}/{gridName1*gridName2:04d}/{gridName1:04d}&{gridName2:04d}'
            ...
            output_file_path_One = f'./ResSimulation_WS/{topology_name}/{gridName1*gridName2:04d}/{gridName1:04d}&{gridName2:04d}/All.txt'
        ...
        for size in gridsize:
            try:
                ...
                grid.set_params(topology_filename=topology_file,
                                ...
                                grid_rows=size[0], grid_cols=size[1], dataflow='ws')
...
if __name__ == '__main__':
    ...
    # Configure logging
    logging.basicConfig(filename='simulation_WS.log', level=logging.INFO,
